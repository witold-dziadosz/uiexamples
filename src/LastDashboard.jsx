export default function LastDashboard() {
    return (
        <>
                                ...
                                <div className="relative flex items-center w-full pl-1 lg:max-w-68 sm:pr-2 sm:ml-0">
                                    ...
                                    <div className="relative flex items-center justify-end w-1/4 p-1 ml-5 mr-4 sm:mr-0 sm:right-auto">
                                        <a href="#" className="relative block">
                                            <img alt="profil" src="/images/person/1.jpg" className="object-cover w-10 h-10 mx-auto rounded-full " />
                                        </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="mb-4">
                                        <div className="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                                            ...
                                            <div className="flex -space-x-2">
                                                <a href="#" className>
                                                    <img className="inline-block object-cover w-10 h-10 rounded-full ring-2 ring-white" src="/images/person/1.jpg" alt="Guy" />
                                                </a>
                                                <a href="#" className>
                                                    <img className="inline-block object-cover w-10 h-10 rounded-full ring-2 ring-white" src="/images/person/2.jpeg" alt="Max" />
                                                </a>
                                                <a href="#" className>
                                                    <img className="inline-block object-cover w-10 h-10 rounded-full ring-2 ring-white" src="/images/person/3.jpg" alt="Charles" />
                                                </a>
                                                <a href="#" className>
                                                    <img className="inline-block object-cover w-10 h-10 rounded-full ring-2 ring-white" src="/images/person/4.jpg" alt="Jade" />
                                                </a>
                                            </div>
                                    ...
                                    <div className="mb-4">
                                        <div className="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                                            ...
                                            <ul>
                                                ...
                                                <li className="flex items-center my-6 space-x-2">
                                                    <a href="#" className="relative block">
                                                        <img alt="profil" src="/images/person/5.jpg" className="object-cover w-10 h-10 mx-auto rounded-full " />
                                                    </a>
                                                    <div className="flex flex-col">
                                                        <span className="ml-2 text-sm font-semibold text-gray-900 dark:text-white">
                                                            Marie Lou
                                                ...
                                                <li className="flex items-center my-6 space-x-2">
                                                    <a href="#" className="relative block">
                                                        <img alt="profil" src="/images/person/7.jpg" className="object-cover w-10 h-10 mx-auto rounded-full " />
                                                    </a>
                                                    <div className="flex flex-col">
                                                        <span className="ml-2 text-sm font-semibold text-gray-900 dark:text-white">
                                                            Marina Farga
